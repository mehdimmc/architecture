package fr.architecture.app.web.rest;

import fr.architecture.app.config.Constants;
import com.codahale.metrics.annotation.Timed;
import fr.architecture.app.domain.User;
import fr.architecture.app.repository.UserRepository;
import fr.architecture.app.repository.search.UserSearchRepository;
import fr.architecture.app.security.AuthoritiesConstants;
import fr.architecture.app.service.MailService;
import fr.architecture.app.service.UserService;
import fr.architecture.app.web.rest.vm.ManagedUserVM;
import fr.architecture.app.web.rest.util.HeaderUtil;
import fr.architecture.app.web.rest.util.PaginationUtil;
